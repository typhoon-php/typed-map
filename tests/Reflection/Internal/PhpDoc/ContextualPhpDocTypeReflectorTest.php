...
final class ContextualPhpDocTypeReflectorTest extends TestCase
{
    ...
    private static function validTypes(): \Generator
    {
        ...
        yield ['array{}', types::arrayShapeSealed()];
        yield ['array{int}', types::arrayShapeSealed([types::int])];
        yield ['array{int, 1?: string}', types::arrayShapeSealed([types::int, 1 => types::optional(types::string)])];
        yield ['array{int, a: string}', types::arrayShapeSealed([types::int, 'a' => types::string])];
        yield ['array{a: int}', types::arrayShapeSealed(['a' => types::int])];
        yield ['array{a?: int}', types::arrayShapeSealed(['a' => types::optional(types::int)])];
