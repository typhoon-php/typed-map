...
final class TypeStringifierTest extends TestCase
{
    ...
    public static function types(): \Generator
    {
        ...
        yield [types::template(templateId(anyClassId(\stdClass::class), 'T')), 'T@stdClass'];
        ...
        yield [types::classString(types::template(templateId(anyClassId(\stdClass::class), 'T'))), 'class-string<T@stdClass>'];
        ...
        yield [types::offset(types::template(templateId(anyClassId('A'), 'T')), types::literalValue('abc')), "T@A['abc']"];
