...
final class StringifyTest extends TestCase
{
    ...
    public static function types(): \Generator
    {
        ...
        yield [types::arrayShapeSealed(), 'array{}'];
        yield [types::arrayShape(), 'array'];
        yield [types::arrayShapeSealed([types::int]), 'array{int}'];
        yield [types::arrayShapeSealed([types::int, 'a' => types::string]), 'array{0: int, a: string}'];
