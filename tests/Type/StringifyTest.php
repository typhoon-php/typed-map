...
final class StringifyTest extends TestCase
{
    ...
    public static function types(): \Generator
    {
        ...
        yield [types::listShapeUnsealed(value: types::mixed), 'list'];
        yield [types::listShape([types::int]), 'list{int}'];
        yield [types::listShape([types::int, types::string]), 'list{int, string}'];
        yield [types::listShapeUnsealed([types::int, 3 => types::string], value: types::mixed), 'list{0: int, 3: string, ...}'];
        yield [types::listShape([types::optional(types::int)]), 'list{0?: int}'];
        yield [types::listShapeUnsealed([types::optional(types::int)], value: types::mixed), 'list{0?: int, ...}'];
        yield [types::listShape([types::optional(types::int)]), 'list{0?: int}'];
        yield [types::listShapeUnsealed([4 => types::float], value: types::string), 'list{4: float, ...<string>}'];
        ...
        yield [types::arrayShapeUnsealed(), 'array'];
        yield [types::arrayShape([types::int]), 'array{int}'];
        yield [types::arrayShape([types::int, 'a' => types::string]), 'array{0: int, a: string}'];
        yield [types::arrayShapeUnsealed([types::int, 'a' => types::string], value: types::mixed), 'array{0: int, a: string, ...}'];
        ...
        yield [types::arrayShapeUnsealed([types::optional(types::int)], value: types::mixed), 'array{0?: int, ...}'];
        yield [types::arrayShape(['a' => types::optional(types::int)]), 'array{a?: int}'];
        yield [types::arrayShapeUnsealed(['a' => types::float], key: types::int, value: types::string), 'array{a: float, ...<int, string>}'];
